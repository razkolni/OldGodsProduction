...
public class SoundGroupVariationInspector : Editor {
    ...
    public override void OnInspectorGUI() {
		...
		EditorGUI.indentLevel = 0;
		var newVolume = DTGUIHelper.DisplayVolumeField(_variation.VarAudio.volume, DTGUIHelper.VolumeFieldType.None, false, 0f, true);
        ...
        if (_variation.useRandomVolume) {
			...
			var newVolMin = DTGUIHelper.DisplayVolumeField(_variation.randomVolumeMin, DTGUIHelper.VolumeFieldType.None, false, volMin, true, "Random Volume Min");
			...
			var newVolMax = DTGUIHelper.DisplayVolumeField(_variation.randomVolumeMax, DTGUIHelper.VolumeFieldType.None, false, volMin, true, "Random Volume Max");
