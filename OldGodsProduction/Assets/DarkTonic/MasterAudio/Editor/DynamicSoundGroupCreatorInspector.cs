...
public class DynamicSoundGroupCreatorInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (MasterAudio.Instance == null) {
            ...
            if (newLang != _creator.previewLanguage) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Preview Language");
        ...
        if (newAllow != _creator.reUseMode) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Items Created When?");
        ...
        if (newIgnore != _creator.errorOnDuplicates) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Error On Duplicate Items");
        ...
        if (newAwake != _creator.createOnAwake) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Auto-create Items");
        ...
        if (newRemove != _creator.removeGroupsOnSceneChange) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Auto-remove Items");
        ...
        if (exp != _creator.itemsCreatedEventExpanded) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle expand Fire 'Items Created' Event");
        ...
        if (_creator.itemsCreatedEventExpanded) {
            ...
            if (existingIndex >= 1) {
                ...
                if (newEventName != _creator.itemsCreatedCustomEvent) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Custom Event Name");
            ...
            if (customEventIndex.HasValue) {
                if (existingIndex != customEventIndex.Value) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Custom Event");
                }
        ...
        if (state != _creator.showMusicDucking) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Dynamic Music Ducking");
        ...
        if (_creator.showMusicDucking) {
            ...
            if (GUILayout.Button(new GUIContent("Add Duck Group"), EditorStyles.toolbarButton, GUILayout.Width(100))) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Add Duck Group");
            ...
            if (_creator.musicDuckingSounds.Count == 0) {
                ...
                for (var i = 0; i < _creator.musicDuckingSounds.Count; i++) {
                    ...
                    if (newIndex >= 0) {
                        if (index != newIndex) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Duck Group");
                        }
                    ...
                    if (newUnduck != duckSound.riseVolStart) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Begin Unduck");
                ...
                if (duckSoundToRemove.HasValue) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "delete Duck Group");
        ...
        if (state != _creator.soundGroupsAreExpanded) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Dynamic Group Mixer");
        ...
        if (_creator.soundGroupsAreExpanded) {
            ...
            if (_audioSourceTemplateNames.Count == 0) {
                ...
                if (newIndex != audSrcTemplateIndex) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Audio Source Template");
            ...
            if (newDragMode != _creator.curDragGroupMode) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bulk Creation Mode");
            ...
            if (bulkMode != _creator.bulkVariationMode) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Variation Mode");
            ...
            if (_creator.groupBuses.Count > 0) {
                ...
                for (var i = 0; i < _creator.groupBuses.Count; i++) {
                    ...
                    if (newBusName != aBus.busName) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bus Name");
                    ...
                    if (!aBus.isExisting) {
                        if (voiceLimitedBuses.Contains(aBus)) {
                            ...
                            if (newMono != aBus.stopOldest) {
                                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Stop Oldest");
                        ...
                        if (busVoiceLimitIndex != oldLimitIndex) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bus Voice Limit");
                        ...
                        if (newBusVol != aBus.volume) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bus Volume");
                    ...
                    if (newChan != aBus.mixerChannel) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bus Mixer Group");
                ...
                if (GUILayout.Button(new GUIContent(buttonText), EditorStyles.toolbarButton, GUILayout.Width(140))) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, buttonText);
        ...
        if (state != _creator.playListExpanded) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Dynamic Playlist Settings");
        ...
        if (_creator.playListExpanded) {
            ...
            if (oldPlayExpanded != _creator.playlistEditorExp) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Playlists");
            ...
            if (_creator.playlistEditorExp) {
                ...
                for (var i = 0; i < _creator.musicPlaylists.Count; i++) {
                    ...
                    if (aList.isExpanded) {
                        ...
                        if (newPlaylist != aList.playlistName) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Name");
                        ...
                        if (crossfadeMode != aList.crossfadeMode) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Crossfade Mode");
                        ...
                        if (aList.crossfadeMode == MasterAudio.Playlist.CrossfadeTimeMode.Override) {
                            ...
                            if (newCf != aList.crossFadeTime) {
                                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Crossfade time (sec)");
                        ...
                        if (newFadeIn != aList.fadeInFirstSong) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Fade In First Song");
                        ...
                        if (newFadeOut != aList.fadeOutLastSong) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Fade Out Last Song");
                        ...
                        if (newTransType != aList.songTransitionType) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Song Transition Type");
                        ...
                        if (newBulkMode != aList.bulkLocationMode) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Bulk Clip Mode");
                        ...
                        if (MasterAudio.HasAsyncResourceLoaderFeature() && playlistHasResource) {
                            if (!maInScene || !ma.resourceClipsAllLoadAsync) {
                                ...
                                if (newAsync != aList.resourceClipsAllLoadAsync) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Load Resources Async");
                        ...
                        for (var j = 0; j < aList.MusicSettings.Count; j++) {
                            ...
                            if (newSongExpanded != aSong.isExpanded) {
                                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Song expand");
                            ...
                            if (aSong.isExpanded) {
                                ...
                                if (newClipSource != aSong.audLocation) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Audio Origin");
                                ...
                                switch (aSong.audLocation) {
                                    case MasterAudio.AudioLocation.Clip:
                                        ...
                                        if (newClip != aSong.clip) {
                                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Clip");
                                            aSong.clip = newClip;
                                            ...
                                            case EventType.DragPerform:
                                                ...
                                                if (anEvent.type == EventType.DragPerform) {
                                                    ...
                                                    foreach (var dragged in DragAndDrop.objectReferences) {
                                                        ...
                                                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Resource Filename");
                                ...
                                if (newVol != aSong.volume) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Volume");
                                    aSong.volume = newVol;
                                }

                                var newPitch = DTGUIHelper.DisplayPitchField(aSong.pitch);
                                if (newPitch != aSong.pitch) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Pitch");
                                ...
                                if (aList.songTransitionType == MasterAudio.SongFadeInPosition.SynchronizeClips) {
                                    ...
                                    if (newLoop != aSong.isLoop) {
                                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Loop Clip");
                                ...
                                if (aList.songTransitionType == MasterAudio.SongFadeInPosition.NewClipFromBeginning) {
                                    ...
                                    if (newStart != aSong.customStartTime) {
                                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Start Time (seconds)");
                                ...
                                if (exp != aSong.songStartedEventExpanded) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle expand Song Started Event");
                                ...
                                if (aSong.songStartedEventExpanded) {
                                    ...
                                    if (maInScene) {
                                        ...
                                        if (newCustomEvent != aSong.songStartedCustomEvent) {
                                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Custom Event Name");
                                ...
                                if (exp != aSong.songChangedEventExpanded) {
                                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle expand Song Changed Event");
                        ...
                        if (addIndex.HasValue) {
                            ...
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "add song");
                            aList.MusicSettings.Insert(addIndex.Value + 1, mus);
                        } else if (removeIndex.HasValue) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "delete song");
                            aList.MusicSettings.RemoveAt(removeIndex.Value);
                        } else if (moveUpIndex.HasValue) {
                            var item = aList.MusicSettings[moveUpIndex.Value];

                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "shift up song");
                            ...
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "shift down song");
                ...
                if (playlistToRemove.HasValue) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "delete Playlist");

                    _creator.musicPlaylists.RemoveAt(playlistToRemove.Value);
                }
                if (playlistToInsertAt.HasValue) {
                    var pl = new MasterAudio.Playlist();
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "add Playlist");
                ...
                if (playlistToMoveUp.HasValue) {
                    ...
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "shift up Playlist");
                ...
                if (playlistToMoveDown.HasValue) {
                    ...
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "shift down Playlist");
        ...
        if (_creator.showCustomEvents != state) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Dynamic Custom Events");
        ...
        if (_creator.showCustomEvents) {
            ...
            if (newEvent != _creator.newEventName) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change New Event Name");
            ...
            for (var i = 0; i < _creator.customEventsToCreate.Count; i++) {
                ...
                if (exp != anEvent.eventExpanded) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle expand Custom Event");
                ...
                if (newName != anEvent.ProspectiveName) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Proposed Event Name");
                ...
                if (rcvMode != anEvent.eventReceiveMode) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Send To Receivers");
                ...
                if (rcvMode == MasterAudio.CustomEventReceiveMode.WhenDistanceLessThan || rcvMode == MasterAudio.CustomEventReceiveMode.WhenDistanceMoreThan) {
                    ...
                    if (newDist != anEvent.distanceThreshold) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "change Distance Threshold");
    ...
    private void ExpandCollapseAllPlaylists(bool expand) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "toggle Expand / Collapse Playlists");
    ...
    private void EqualizePlaylistVolumes(List<MusicSetting> playlistClips) {
        ...
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Equalize Song Volumes");
    ...
    private void SortCustomEvents() {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Sort Custom Events Alpha");
    ...
    private void ExpandCollapseCustomEvents(bool shouldExpand) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Expand / Collapse All Custom Events");
    ...
    private void SortSongsAlpha(MasterAudio.Playlist aList) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Sort Playlist Songs Alpha");
    ...
    private void ExpandCollapseSongs(MasterAudio.Playlist aList, bool shouldExpand) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Expand / Collapse Playlist Songs");
    ...
    private void AddAudioSourceTemplate(GameObject temp) {
        ...
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _creator, "Add Audio Source Template");
