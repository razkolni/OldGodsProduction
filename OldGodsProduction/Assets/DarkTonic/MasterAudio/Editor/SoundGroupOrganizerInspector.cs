...
public class SoundGroupOrganizerInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (MasterAudio.Instance == null) {
            ...
            if (newLang != _organizer.previewLanguage) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Preview Language");
        ...
        if (newType != _organizer.itemType) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Item Type");
        ...
        if (newMode != _organizer.transMode) {
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Transfer Mode");
                ...
                case SoundGroupOrganizer.TransferMode.Import:
                    if (sources.Count == 0) {
                        ...
                        if (newIndex != srcIndex) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Source Object");
                        }
                        ...
                        if (_organizer.sourceObject != null) {
                            ...
                            foreach (var aGroup in _organizer.selectedSourceSoundGroups) {
                                ...
                                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "toggle Sound Group selection");
                ...
                case SoundGroupOrganizer.TransferMode.Export:
                    if (_groups.Count == 0) {
                        ...
                        if (newIndex != destIndex) {
                            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Destination Object");
                        }
                    ...
                    if (sources.Count == 0) {
                        ...
                        if (_organizer.sourceObject != null) {
                            ...
                            foreach (var aEvent in _organizer.selectedSourceCustomEvents) {
                                ...
                                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "toggle Custom Event selection");
    ...
    // non-clickable
            ...
            if (newDragMode != _organizer.curDragGroupMode) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Bulk Creation Mode");
            ...
            if (bulkMode != _organizer.bulkVariationMode) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Variation Mode");
            ...
            if (_groups.Count > 0) {
                ...
                if (newUseTextGroupFilter != _organizer.useTextGroupFilter) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "toggle Use Text Group Filter");
                ...
                if (_organizer.useTextGroupFilter) {
                    ...
                    if (newTextFilter != _organizer.textGroupFilter) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Text Group Filter");
       ...
       // non-clickable
            ...
            if (newEvent != _organizer.newEventName) {
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change New Event Name");
            ...
            for (var i = 0; i < _organizer.customEvents.Count; i++) {
                ...
                if (exp != anEvent.eventExpanded) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "toggle expand Custom Event");
                ...
                if (newName != anEvent.ProspectiveName) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Proposed Event Name");
                ...
                if (rcvMode != anEvent.eventReceiveMode) {
                    UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Send To Receivers");
                ...
                if (rcvMode == MasterAudio.CustomEventReceiveMode.WhenDistanceLessThan || rcvMode == MasterAudio.CustomEventReceiveMode.WhenDistanceMoreThan) {
                    ...
                    if (newDist != anEvent.distanceThreshold) {
                        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "change Distance Threshold");
    ...
    private void CheckUncheckAllDestGroups(bool shouldCheck) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "check/uncheck All destination Groups");
    ...
    private void CheckUncheckAllDestEvents(bool shouldCheck) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "check/uncheck All destination Custom Events");
    ...
    private void CheckUncheckAllSourceGroups(bool shouldCheck) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "check/uncheck All source Groups");
    ...
    private void CheckUncheckAllSourceEvents(bool shouldCheck) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "check/uncheck All source Custom Events");
    ...
    private void ImportSelectedEvents() {
        ...
        foreach (var item in _organizer.selectedSourceCustomEvents) {
            ...
            UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "import Organizer Custom Event(s)");
    ...
    private void ExportSelectedEvents() {
        ...
        foreach (var item in _organizer.selectedDestCustomEvents) {
            ...
            if (isDestDgsc) {
                ...
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, dgsc, "export Custom Event(s)");
                ...
                UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, ma, "export Custom Event(s)");
    ...
    private void ExpandCollapseCustomEvents(bool shouldExpand) {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "Expand / Collapse All Custom Events");
    ...
    private void SortCustomEvents() {
        UndoHelper.RecordObjectPropertyForUndo(ref _isDirty, _organizer, "Sort Custom Events Alpha");
